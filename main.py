        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <ul>
                    ...
                    <li><a href="https://github.com/Azure-Samples/python-mcp-demos" target="_blank">Python MCP Demos</a> — End-to-end MCP server development with FastMCP, from local debugging to production deployment on Azure Container Apps with OAuth authentication</li>
                </ul>
            </div>
            <footer>
